...
${OBJECTDIR}/AllocatedObjects-Quantity.o: AllocatedObjects-Quantity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllocatedObjects-Quantity.o AllocatedObjects-Quantity.cpp

${OBJECTDIR}/CheckInstances.o: CheckInstances.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckInstances.o CheckInstances.cpp
...
${OBJECTDIR}/FriendClasses.o: FriendClasses.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FriendClasses.o FriendClasses.cpp
...
${OBJECTDIR}/Namespace.o: Namespace.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Namespace.o Namespace.cpp
...
${OBJECTDIR}/OverloadingConstructors.o: OverloadingConstructors.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OverloadingConstructors.o OverloadingConstructors.cpp
...
${OBJECTDIR}/PointerToClasses.o: PointerToClasses.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointerToClasses.o PointerToClasses.cpp

${OBJECTDIR}/PointerToFunction.o: PointerToFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointerToFunction.o PointerToFunction.cpp

${OBJECTDIR}/Polymorphism.o: Polymorphism.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Polymorphism.o Polymorphism.cpp
...
${OBJECTDIR}/StandardMacroNames.o: StandardMacroNames.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StandardMacroNames.o StandardMacroNames.cpp
...
${OBJECTDIR}/TemplateNonType.o: TemplateNonType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TemplateNonType.o TemplateNonType.cpp
...
${OBJECTDIR}/VirtualMember.o: VirtualMember.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VirtualMember.o VirtualMember.cpp
