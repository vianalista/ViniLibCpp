...
${OBJECTDIR}/FileStream.o: FileStream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileStream.o FileStream.cpp
...
${OBJECTDIR}/LineControlForEasyDebug.o: LineControlForEasyDebug.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineControlForEasyDebug.o LineControlForEasyDebug.cpp
...
${OBJECTDIR}/TypeCasting.o: TypeCasting.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TypeCasting.o TypeCasting.cpp
